...
def train_GAN(epochs = 30, batch_size = 8, Tile_size = 64, lr_d = 0.0001, lr_g = 0.0002):
    ...
    dataloader = create_dataloader(brain="Vervet1818", map_type="FOM", patch_size=Tile_size, batch_size=batch_size)
...
def train_WGAN(epochs = 30, batch_size = 8, Tile_size = 64, lr_d = 0.0001, lr_g = 0.0001):
    ...
    dataloader = create_dataloader(brain="Vervet1818", map_type="FOM", patch_size=Tile_size, batch_size=8)
